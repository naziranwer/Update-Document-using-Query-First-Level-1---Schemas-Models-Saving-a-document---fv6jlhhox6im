...
const updateProduct = async (req, res) => {
    try {
        ...
        // Only update properties that are provided in the updatedData object
        ...
        // If there is an error while updating the product, return a 400 status code with the error message
        res.status(400).json({
            message: "Product Updation Failed",
            status: "Error",
            error: err.message,
